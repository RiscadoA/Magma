...
void LoadScene(Scene& scene)
{
	...
	// Load vertex buffer
	{
		scene.vertexBuffer = scene.device->CreateVertexBuffer(sizeof(Vertex) * 4, nullptr, Graphics::V1X::BufferUsage::Dynamic);
	}
	...
	// Create raster state
	{
		...
		//desc.rasterMode = Graphics::V1X::RasterMode::Line;
