...
void Main(int argc, char** argv)
{
...

	{
		...
		{
			auto file = fileSystem->OpenFile(Files::FileMode::Read, "/Example-4/vertex.mslbc");
		...
		{
			auto file = fileSystem->OpenFile(Files::FileMode::Read, "/Example-4/vertex.mslmd");
			auto size = fileSystem->GetSize(file);
			auto code = new char[size + 1];
			fileSystem->Read(file, code, size);
			fileSystem->CloseFile(file);
		...
		{
			auto file = fileSystem->OpenFile(Files::FileMode::Write, "/Example-4/vertex.mslbo");
		...
		{
			auto file = fileSystem->OpenFile(Files::FileMode::Read, "/Example-4/vertex.mslbo");
...

	{
		...
		{
			auto file = fileSystem->OpenFile(Files::FileMode::Read, "/Example-4/pixel.mslbc");
			auto size = fileSystem->GetSize(file);
			auto code = new char[size + 1];
			fileSystem->Read(file, code, size);
			fileSystem->CloseFile(file);
		...
		{
			auto file = fileSystem->OpenFile(Files::FileMode::Read, "/Example-4/pixel.mslmd");
			auto size = fileSystem->GetSize(file);
			auto code = new char[size + 1];
			fileSystem->Read(file, code, size);
			fileSystem->CloseFile(file);
		...
		{
			auto file = fileSystem->OpenFile(Files::FileMode::Write, "/Example-4/pixel.mslbo");
			auto bytecodeSizeBE = String::U32ToBE(bytecodeSize);
			fileSystem->Write(file, &bytecodeSizeBE, sizeof(unsigned long));
			fileSystem->Write(file, bytecode, bytecodeSize);
		...
		{
			auto file = fileSystem->OpenFile(Files::FileMode::Read, "/Example-4/pixel.mslbo");
			binaryObjectSize = fileSystem->GetSize(file);
			binaryObject = new char[binaryObjectSize];
			fileSystem->Read(file, binaryObject, binaryObjectSize);
			fileSystem->CloseFile(file);
