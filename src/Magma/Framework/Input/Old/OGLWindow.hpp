...
namespace Magma
{
	namespace Framework
	{
		namespace Input
		{
			...
			/// </summary>
			class OGLWindow : public WindowHandle
			{
			public:
				/// <summary>
				...
				OGLWindow(mfmU32 width, mfmU32 height, const String::UTF8CodeUnit* title, WindowHandle::Mode mode = WindowHandle::Mode::Windowed);
