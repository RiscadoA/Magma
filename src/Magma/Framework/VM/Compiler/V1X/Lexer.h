...
static const mfvV1XTokenInfo MFV_V1X_TINFO_INT_LITEREAL			= { MFV_V1X_TOKEN_INT_LITERAL, MFM_FALSE, MFM_FALSE, MFM_FALSE, u8"int-literal" };
...
static const mfvV1XTokenInfo MFV_V1X_TINFO_IDENTIFER			= { MFV_V1X_TOKEN_IDENTIFIER, MFM_FALSE, MFM_FALSE, MFM_FALSE, u8"identifier" };
