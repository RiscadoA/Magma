...
std::vector<ShaderFunction> Magma::Framework::Graphics::V1X::Version_1_X::ShaderFunctions =
{
	// 1.0
...
void Magma::Framework::Graphics::V1X::Version_1_X::ShaderAnnotator::Run(ShaderSTNode * tree, ShaderCompilerData & data)
{
...
void Magma::Framework::Graphics::V1X::Version_1_X::ShaderAnnotator::Print(ShaderSTNode * node, size_t indentation)
{
