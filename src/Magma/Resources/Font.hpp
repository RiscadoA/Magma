...
namespace Magma
{
	namespace Resources
	{
		...
		{
		public:
			Font(Resource* rsc, Framework::Graphics::V1X::RenderDevice* device, const unsigned char* data, size_t size, size_t charWidth, size_t charHeight, size_t atlasWidth, size_t atlasHeight, size_t maxAtlasCount);
		...
		{
		public:
			FontImporter(Manager* manager, Framework::Graphics::V1X::RenderDevice* device);
