...
namespace Magma
{
	namespace GUI
	{
		...
		public:
			...
			/// </summary>
			Renderer(Framework::Graphics_V1X::RenderDevice* device);
			~Renderer();
		...
		private:
			...
			Framework::Graphics_V1X::DepthStencilState* m_depthStencilState;
			Framework::Graphics_V1X::BlendState* m_blendState;
		};
