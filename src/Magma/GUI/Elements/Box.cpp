	...
	m_vs(vertexShader)
{
	...
	{
		Framework::Graphics::VertexElement elements[1];
		...
		elements[0].type = Framework::Graphics::VertexElementType::Float;
	...
	m_boxDataCB = m_renderDevice->CreateConstantBuffer(sizeof(BoxDataCB), nullptr, Framework::Graphics::BufferUsage::Dynamic);
...
Magma::Framework::Graphics::Pipeline * Magma::GUI::Elements::BoxRenderer::GetPipeline(Box * box)
{
	for (auto& pp : m_pps)
